    ...
    <div>
      ...
      <div className="space-y-3">
        {sortedLines.map((line, index) => (
          <div key={line.id} className="flex gap-2 items-start p-3 border rounded-lg hover:bg-gray-50">
            ...
            <div className="flex-1">
              <div className="flex gap-2 mb-1">
                <input 
                  ...
                  className="w-28 p-1.5 border rounded text-xs font-mono bg-gray-50" 
